  ...
  return (
    <div className='flex flex-col p-4 sm:h-screen'>
      ...
      <div className='mt-8 px-6'>
        ...
        <ul
          className='flex items-center space-x-6 sm:space-x-0 overflow-x-auto py-2 thin-scrollbar mt-5 md:flex-col space-y-2 sm:h-[520px] overflow-auto thin-scrollbar sm:items-start'
        >
